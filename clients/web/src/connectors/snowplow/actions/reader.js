export const readerActions = {
  ...
  'reader.rec.unsave': {
    ...
    expects: ['corpusRecommendationId', 'url', 'position'],
    description:
      'Fired when a user clicks the `Saved` button post-save on a Rec at the bottom of Reader'
  },
  'highlights.limit.sidebar': {
    ...
    description:
      'Fired when a user sees the premium upsell in the sidebar after making 3 highlights on Reader'
  },
  ...
  'reader.remove-highlight': {
    ...
    expects: ['url'],
    description:
      'Fired when a clicks the Delete button on the popout menu on any Highlight (in text, sidebar, or highlight flyaway)'
  },
  'reader.share': {
    eventType: 'engagement',
    entityTypes: ['content', 'ui'],
    ...
    expects: ['url'],
    description:
      'Fired when a user clicks the Share button: top of Reader, any Highlight (in text, sidebar, or highlight flyaway), or after selecting text'
  },
  'reader.display': {
    eventType: 'engagement',
    entityTypes: ['ui'],
    ...
    expects: ['value', 'label'],
    description:
      'Fired when a user updates any display settings. Label is the type of setting, value is the new setting'
  },
  'reader.goback': {
    eventType: 'engagement',
    entityTypes: ['ui'],
