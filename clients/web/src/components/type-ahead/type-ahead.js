...
export class TypeAhead extends React.Component {
  ...
  selectedUp = () => {
    const nextIndex =
      this.state.selectedIndex > 0 ? this.state.selectedIndex - 1 : this.state.items.length - 1
    this.setState({ selectedIndex: nextIndex })
  }

  selectedDown = () => {
    const nextIndex =
      this.state.selectedIndex < this.state.items.length - 1 ? this.state.selectedIndex + 1 : 0
    this.setState({ selectedIndex: nextIndex })
  }
