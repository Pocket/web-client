...
export const TopicHeadings = ({ topic, type = 'title' }) => {
  ...
  const headings = {
    ...
    career: {
      ...
      subtitle: t(
        'topic:subtitle-career',
        'Productivity tips, professional development, and the future of work.'
      )
    },
    education: {
    ...
    food: {
      ...
      subtitle: t(
        'topic:subtitle-food',
        'Time-tested recipes, kitchen tips, and why we eat the way we do.'
      )
    },
    gaming: {
      title: t('topic:title-gaming', 'Gaming'),
      subtitle: t(
        'topic:subtitle-gaming',
        'Video games, board games, and the players who play them.'
      )
    },
    health: {
    ...
    'self-improvement': {
      ...
      subtitle: t(
        'topic:subtitle-self-improvement',
        'Smarter living, better habits, and lasting happiness.'
      )
    },
    sports: {
      title: t('topic:title-sports', 'Sports'),
      subtitle: t(
        'topic:subtitle-sports',
        'Slam dunks, corner goals, home runs, touchdowns and more.'
      )
    },
    technology: {
