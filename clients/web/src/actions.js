...
export const USER_TOGGLE_PREMIUM = 'USER_TOGGLE_PREMIUM'
...
export const ARTICLE_GET_PONG = 'ARTICLE_GET_PONG'
...
export const READ_ITEM_RESOLVED = 'READ_ITEM_RESOLVED'
export const READ_ITEM_FAILURE = 'READ_ITEM_FAILURE'
export const READ_META_SUCCESS = 'READ_META_SUCCESS'
...
export const MUTATION_IMPORT_SHOW = 'MUTATION_IMPORT_SHOW'
export const MUTATION_IMPORT_CANCEL = 'MUTATION_IMPORT_CANCEL'
export const MUTATION_IMPORT_CONFIRM = 'MUTATION_IMPORT_CONFIRM'
export const MUTATION_IMPORT_SUCCESS = 'MUTATION_IMPORT_SUCCESS'
export const MUTATION_IMPORT_FAILURE = 'MUTATION_IMPORT_FAILURE'
...
export const SEARCH_SAVES_REQUEST = 'SEARCH_SAVES_REQUEST'
export const SEARCH_SAVES_FAILURE = 'SEARCH_SAVES_FAILURE'
export const SEARCH_SAVES_SUCCESS = 'SEARCH_SAVES_SUCCESS'
export const SEARCH_SAVES_LOAD_MORE = 'SEARCH_SAVES_LOAD_MORE'
export const SEARCH_SAVES_LOAD_PREVIOUS = 'SEARCH_SAVES_LOAD_PREVIOUS'
export const SEARCH_SAVES_PAGE_INFO_SUCCESS = 'SEARCH_SAVES_PAGE_INFO_SUCCESS'
export const SEARCH_SAVES_HYDRATE = 'SEARCH_SAVES_HYDRATE'

export const SEARCH_CORPUS_REQUEST = 'SEARCH_CORPUS_REQUEST'
export const SEARCH_CORPUS_FAILURE = 'SEARCH_CORPUS_FAILURE'
export const SEARCH_CORPUS_SUCCESS = 'SEARCH_CORPUS_SUCCESS'
export const SEARCH_CORPUS_DISMISS = 'SEARCH_CORPUS_DISMISS'
export const SEARCH_CORPUS_PAGE_INFO_SUCCESS = 'SEARCH_CORPUS_PAGE_INFO_SUCCESS'
export const SEARCH_CORPUS_LOAD_MORE = 'SEARCH_CORPUS_LOAD_MORE'
export const SEARCH_CORPUS_LOAD_PREVIOUS = 'SEARCH_CORPUS_LOAD_PREVIOUS'
export const SEARCH_CORPUS_HYDRATE = 'SEARCH_CORPUS_HYDRATE'

export const PLACARD_REQUEST = 'PLACARD_REQUEST'
export const PLACARD_SUCCESS = 'PLACARD_SUCCESS'
export const PLACARD_FAILURE = 'PLACARD_FAILURE'